...
_SYSTEM_PROMPT = (
    ...
    "details that aren't in the input. Reply in JAPANESE (日本語) by "
    "default; if the page is unambiguously a non-Japanese site (English, "
    "Korean, Chinese, etc.) you may reply in that page's language. Keep "
    "quoted button/link text in its original language.\n\n"
